...
#SBATCH --output=logs/suprem_abdomenatlas_%j.out
#SBATCH --error=logs/suprem_abdomenatlas_%j.err
...
SAVE_DIR="/uhome/hoda2/projects/p60290_1/AbdomenAtlas/SuPreM/suprem_preds/abdomenatlas_intestinal"
...
PYTHONWARNINGS=ignore python inference_abdomenatlas.py \
