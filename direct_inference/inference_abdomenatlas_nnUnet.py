...
def run_inference(args):
    ...
    # Load model
    print(f"Loading Universal_model with {args.backbone} backbone...")
...
def main():
    parser = argparse.ArgumentParser(description="SuPreM inference on AbdomenAtlas1.1 for intestinal tract organs (unet backbone)")
    ...
    parser.add_argument('--backbone', default='unet', help='Backbone architecture')
