#!/bin/bash
#SBATCH --job-name=raos_tr_swin
#SBATCH --partition=gpu-h200
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=12:00:00
#SBATCH --output=logs/raos_tr_swin_%j.out
#SBATCH --error=logs/raos_tr_swin_%j.err
...
CKPT="$ROOT/supervised_suprem_swinunetr_2100.pth"
SAVE="$ROOT/raos_tr_suprem/swinunetr"
